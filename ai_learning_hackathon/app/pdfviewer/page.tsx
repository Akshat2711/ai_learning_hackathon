...
import ChatSidebar from '@/components/pdfviewer_chat';
    ...
    useEffect(() => {
        ...
        const renderPage = async () => {
            try {
                ...
                // ✅ Only pass `canvasContext` and `viewport` — the `canvas` property
                //    is not part of pdfjs RenderParameters and causes a Turbopack type error.
